          ...
          {softSkills.map((skill, index) => {
            ...
            return (
              ...
              >
                ...
                <div 
                  className="relative bg-[#0d1b2e] border rounded-xl p-6 h-full min-h-45 flex flex-col items-center justify-center text-center transition-all duration-300 group-hover:bg-[#112238]"
                  style={{
