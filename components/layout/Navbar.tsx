...
export const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <motion.div
          className="lg:hidden fixed inset-x-0 top-16 bottom-0 bg-[#050b18]/95 backdrop-blur-xl border-t border-purple-500/20 z-40"
            ...
            <div className="space-y-2">
              {navItems[lang].map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="block text-gray-200 hover:text-cyan-300 transition-colors duration-300 py-3 text-2xl font-semibold"
